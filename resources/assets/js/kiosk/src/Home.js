                    ...
                    <div className='container-fluid h-100'>
                        <div className='row justify-content-center align-items-center h-100'>
                            <div className='col-12 mx-4 mt-4 d-flex justify-content-between align-items-center'>
                                <div>
                                    <button className="btn btn-lg thema-background-color text-white">
                                    <i className="fas fa-redo-alt"></i> Refresh Qr
                                    </button>
                                </div>
                                <p className='display-4'> {this.state.data.businessName} </p> 
                                <div> 
                                    <button type="button" className="btn btn-lg thema-background-color text-white"><i className="fas fa-sign-out-alt"></i>Logout</button>
                                </div>
                            </div>
                                <div className='col-9 text-center'>
                                {this.state.loading === true && <img className='my-auto mt-16' src='/public/loading.gif' />}
