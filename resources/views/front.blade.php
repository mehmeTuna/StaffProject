    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-navbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/kiosk">Kiosk Register</a></li>
            ...
            <div class="col-md-5 relative align-self-center">
                ...
                <form action="/business/register" method="post" class="bg-white rounded pb_form_v1">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control pb_height-50 reverse" name="businessName" placeholder="Business Name">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control pb_height-50 reverse" name="telephone" placeholder="Telephone">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control pb_height-50 reverse" name="email" placeholder="Business Email">
                    </div>
                    <div class="form-group">
